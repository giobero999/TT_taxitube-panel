          ...
          <div class="row">
            <div class="col-lg-12">
              <table class="table table-hover dataTable" id="table-editable">
                <thead>
                  <tr>
                    ...
                    <th>start time</th>
                    <th>end time</th>
                    <th class="text-right">check it</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
              ...
              <div class="col-md-2 pull-left">
                <a href="index1.html">
                  <button class="btn btn-warning" id="set-img-3" type="button">
              ...
              <div class="col-md-2 pull-right">
                <button class="btn btn-success" data-toggle="modal" data-target="#myModal" id="set-img-3" type="button">
                      finish
