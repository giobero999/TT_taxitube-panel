                    ...
                    <div class="row">
                      <div class="col-md-8">
                        <div class="img-preview img-preview-sm" style="overflow: hidden;">
                          <img src="../assets/global/images/gallery/4.jpg" alt="screeen 1" style="height: 113px; margin-left: -20px; margin-top: -11px; width: 200px;"></div>
                      </div>
                      <div class="col-md-4">
                        <div class="img-preview img-preview-xs" style="overflow: hidden;">
                          <img src="../assets/global/images/gallery/7.jpg" alt="screeen 2" style="height: 45px; margin-left: -8px; margin-top: -4px; width: 80px;"></div>
                      </div>
                    </div>
                    <hr>
                    <button class="btn btn-dark btn sm" id="set-img-1" type="button">Left Screen</button>
                    <button class="btn btn-dark btn sm" id="set-img-2" type="button">Right Screen</button>
