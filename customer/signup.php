                    ...
                    <div class="account-wall">
                        ...
                        <form class="form-signup" action="dashboard.php" role="form">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="append-icon">
                                        <input type="text" name="name" id="name" class="form-control form-white address" placeholder="Address Line 1" required autofocus>
                                        <i class="icon-address"></i>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="append-icon">
                                        <input type="text" name="Customer_Id" id="Customer_Id" class="form-control form-white lastname" placeholder="Address Line 2">
                                        <i class="icon-"></i>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="append-icon">
                                        <input type="text" name="name" id="name" class="form-control form-white firstname" placeholder="City" required autofocus>
                                        <i class="icon-"></i>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="append-icon">
                                        <input type="text" name="Customer_Id" id="Customer_Id" class="form-control form-white lastname" placeholder="Country">
                                        <i class="icon-"></i>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="append-icon">
                                        <input type="text" name="Customer_Id" id="Customer_Id" class="form-control form-white lastname" placeholder="Post Code">
                                        <i class="icon-"></i>
                                    </div>
                                </div>
                            ...
                            <div class="append-icon">
                                <input type="file" name="Username" id="Username" class="form-control form-white email" placeholder="logo" required>
                                <i class="icon-file"></i>
                            </div>
                            ...
                            <button type="submit" id="submit-form" class="btn btn-lg btn-dark m-t-20" data-style="expand-left"><a href="index.php">Register</a></button>
