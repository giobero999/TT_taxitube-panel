    ...
    <body class="account separate-inputs" data-page="login">
        ...
        <div class="container" id="login-block" >
                ...
                <div class="col-sm-6 col-md-4 col-md-offset-4">
                    <div class="account-wall">
                        ...
                        <form class="form-signin" role="form">
                            ...
                            <button type="submit" id="submit-form" class="btn btn-lg btn-danger btn-block ladda-button" data-style="expand-left"><a href="index.php">Sign In</a></button>
            ...
            <p class="account-copyright">
                <span>Copyright © 2015 </span><span></span><span>All rights reserved.</span>
            </p>
