    ...
    ?>
     ...
     ?>
        ...
        <div class="page-content">
          <div class="header">
            <h2><strong>Vector</strong> Maps</h2>
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="panel bg-primary widget-map">
                <div class="panel-content widget-full">
                  <div class="row">
                    <div class="col-md-12">
          ...
          <div class="row m-t-10">
            <div class="col-lg-6">
              <div class="panel widget-map">
                <div class="panel-header z2 panel-controls">
                  <h3><i class="icon-globe-alt"></i> <strong>USA</strong> Map</h3>
                </div>
                <div class="panel-content widget-full">
                  <div class="row">
                    <div class="col-md-12">
            ...
            <div class="col-lg-6">
              <div class="panel bg-dark widget-map">
                <div class="panel-header panel-controls">
                  <h3><i class="icon-globe-alt"></i> <strong>Pattern</strong> Map</h3>
                </div>
                <div class="panel-content widget-full">
                  <div class="row">
                    <div class="col-md-12">
