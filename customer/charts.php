...
<html lang="en">
  ...
  <!-- BEGIN BODY -->
  <body class="sidebar-condensed sidebar-condensed fixed-topbar fixed-sidebar theme-sdtl color-default">
    <!--[if lt IE 7]>
    ...
    ?>
     ...
     ?>
        ...
        <div class="page-content">
          ...
          <div class="row">
            <div class="col-sm-6">
              <h3><strong>Radar</strong> Charts</h3>
              <p>A radar chart is a way of showing multiple data points and the variation between them.<br>
                They are often useful for comparing the points of two or more different data sets.
              </p>
              <canvas id="radar-chart" class="full" height="140"></canvas>
            </div>
            <div class="col-sm-6">
          ...
          <div class="row m-t-40">
            <div class="col-sm-6">
              ...
              <p>Pie and doughnut charts are probably the most commonly used chart there are. <br>
    ...
    <script src="../assets/global/js/pages/charts.js"></script>
    <!-- END PAGE SCRIPT -->
