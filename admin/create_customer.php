            ...
            <div class="col-lg-12 portlets">
              <div class="panel">
                <div class="panel-header panel-controls">
                  <h3><i class="icon-bulb"></i> Create <strong>Customer</strong></h3>
                </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" data-mask="999-99-99-99" class="form-control" placeholder="Phone">
                      </div>
                      <div class="form-group">
                      ...
                      <!-- <div class="form-group">
                        ...
                        <input type="text"  class="form-control" placeholder="privilege">
                      </div> -->
                      <div class="form-group">
                        <label class="form-label">Logo Upload</label>
                        <input type="file"   class="form-control" placeholder="Logo Upload">
                      </div>
                    </div>
